...
Esta sección se dividirá en dos subsecciones, en la primera analizaremos las cuadradas de frecuencias relacionadas con la de $W_{0_{1}} \approx 607,3$ y en la siguiente para las cuadradas de frecuencias relacionadas a $W_{0_{2}}$. Recordemos que $f = \frac{W}{2 \cdot \pi}$
...
Para una señal cuadrada de frecuencia $f_{0_{1}}/10 \approx 9,665Hz$ vemos que 
