...
\caption{Respuesta a la cuadrada de frecuencia $\frac{f_{0}}{10}$}
\end{figure}

\newpage
\begin{figure}[h!]
\includegraphics[scale=1]{RtaCuadradaWo12.png}
\caption{Respuesta a la cuadrada de frecuencia $f_{0}$}
\end{figure}

\newpage
\begin{figure}[h!]
\includegraphics[scale=1]{RtaCuadradaWo13.png}
\caption{Respuesta a la cuadrada de frecuencia $f_{0} \cdot 10$}
\end{figure}
