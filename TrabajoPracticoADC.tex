...
$20 \cdot \log(|H(jw)|)$. Dado que el filtro es un pasabanda era lo esperable
...
Los valores de este gráfico vienen dados por la fórmula $\arctan(\frac{\Im(H(jw))}{\Re(H(jw)})$
Dado que el numerador de la función se compone de un único término $3948 \cdot s^2$ 
tenemos que la constante positiva aporta $0\degree$ mientras que el  
