...
\bigskip
Calculando para cada polo y reescribiendo las exponenciales complejas como combinación de senos y cosenos terminamos que la respuesta a la senoidal es

\[\mathcal{L}^{-1}\{F(s)\}(t) \approx -80,14 \cdot 10^{-3} \cdot \cos(630 \cdot t) + 1,0304 \cdot \sin(630 \cdot t)\] 
\[+ e^{-21,4 \cdot t} \cdot [- 496,6 \cdot 10^{-3} \cdot \cos(606,8 \cdot t)]\]
